...
PERMISSION_HELPERS = {
    ...
    "expenses.pay": {
        "label": "Pay Expenses",
        "helper_text": "Record payment for approved expense records.",
    },
    "finance_vendors.deactivate": {
        "label": "Deactivate Finance Vendors",
        "helper_text": "Deactivate Finance vendor records.",
    },
    "vendor_bills.approve": {
        "label": "Approve Vendor Bills",
        "helper_text": "Approve submitted vendor bills.",
    },
    "vendor_bills.reject": {
        "label": "Reject Vendor Bills",
        "helper_text": "Reject submitted vendor bills.",
    },
    "vendor_bills.pay": {
        "label": "Pay Vendor Bills",
        "helper_text": "Record payment for approved vendor bills.",
    },
    "vendor_bills.void": {
        "label": "Void Vendor Bills",
        "helper_text": "Void unpaid vendor bills.",
    },
    "petty_cash.approve": {
        "label": "Approve Petty Cash",
        "helper_text": "Approve requested petty cash advances.",
    },
    "petty_cash.reject": {
        "label": "Reject Petty Cash",
        "helper_text": "Reject requested petty cash advances.",
    },
    "petty_cash.issue": {
        "label": "Issue Petty Cash",
        "helper_text": "Record petty cash issued from a cash account.",
    },
    "petty_cash.retire": {
        "label": "Retire Petty Cash",
        "helper_text": "Record spend and returned cash against issued advances.",
    },
    "petty_cash.cancel": {
