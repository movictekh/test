...
from user.models.branch import Branch, BranchBusinessHours
from user.api.schemas.branch import (
    BranchSchema,
    BranchCreateSchema,
    BranchUpdateSchema,
    BranchChoicesSchema,
    BranchPerformanceAnalysisSchema,
    BusinessHoursSchema,
...
@branch_api.get("/branches/{branch_id}", response={200: BranchSchema, 404: MessageSchema})
...
def create_branch(request, payload: BranchCreateSchema):
    try:
        ...
        # Create branch
        branch_data = payload.dict(exclude={'manager_id', 'branch_file', 'business_hours'})
...
@branch_api.put("/branches/{branch_id}", response={200: BranchSchema, 400: MessageSchema, 404: MessageSchema})
...
@branch_api.get("/branches/{branch_id}/business-hours", response={200: List[BusinessHoursSchema], 404: MessageSchema})
...
@branch_api.put("/branches/{branch_id}/business-hours", response={200: List[BusinessHoursSchema], 400: MessageSchema, 404: MessageSchema})
@require_permission("branches", "update")
def set_branch_business_hours(request, branch_id: int, payload: List[BusinessHoursInputSchema]):
    try:
        branch = Branch.objects.get(id=branch_id)
...
@branch_api.get("/branches/{branch_id}/performance", response={200: BranchPerformanceAnalysisSchema, 404: MessageSchema})
def get_branch_performance(request, branch_id: int):
    try:
        ...
        return 200, {
            ...
            "revenue_trend": [
                {"month": "Jan", "actual_revenue": 38000000, "projected_revenue": 35000000},
                {"month": "Jan", "actual_revenue": 39000000, "projected_revenue": 36000000},
                {"month": "Jan", "actual_revenue": 40500000, "projected_revenue": 37000000},
                {"month": "Feb", "actual_revenue": 40000000, "projected_revenue": 37500000},
                {"month": "Feb", "actual_revenue": 39500000, "projected_revenue": 38000000},
                {"month": "Mar", "actual_revenue": 42000000, "projected_revenue": 39000000},
                {"month": "Mar", "actual_revenue": 43500000, "projected_revenue": 40000000},
                {"month": "Mar", "actual_revenue": 44500000, "projected_revenue": 41000000},
                {"month": "Apr", "actual_revenue": 45500000, "projected_revenue": 41500000},
                {"month": "Apr", "actual_revenue": 46000000, "projected_revenue": 42000000},
                {"month": "May", "actual_revenue": 45500000, "projected_revenue": 42000000},
                {"month": "May", "actual_revenue": 44500000, "projected_revenue": 41500000}
            ],
            "branch_details": {
