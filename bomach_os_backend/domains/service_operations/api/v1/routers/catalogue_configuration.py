"""Service catalogue configuration and branch-activation HTTP endpoints."""
...
configuration_router = Router(tags=["Services"])


@configuration_router.get(
    "/request-field-types",
    response=List[FieldTypeOut],
    operation_id="services_api_v1_services_list_request_field_types",
)
...
@configuration_router.get(
    ...
    operation_id="services_api_v1_services_list_pricing_configs",
)
...
@configuration_router.get(
    "/{service_id}/request-forms",
    response=List[Dict[str, Any]],
    operation_id="services_api_v1_services_list_request_forms",
)
@require_permission("service_request_forms", "list")
...
@configuration_router.post(
    ...
    operation_id="services_api_v1_services_create_request_form",
)
...
def create_request_form(request, service_id: int, payload: RequestFormIn):
    try:
        ...
        form = domain_services.create_request_form(
            service,
            payload,
...
@configuration_router.get(
    ...
    operation_id="services_api_v1_services_get_request_form",
)
...
@configuration_router.put(
    ...
    operation_id="services_api_v1_services_update_request_form",
)
...
def update_request_form(
    ...
    try:
        ...
        return 200, _serialize_request_form(
            domain_services.update_request_form(form, payload)
        )
    except (ValidationError, IntegrityError) as e:
        return 400, {"detail": _validation_detail(e)}
...
@configuration_router.delete(
    ...
    operation_id="services_api_v1_services_delete_request_form",
)
...
def delete_request_form(request, service_id: int, form_id: int):
    ...
    return 200, {
        "detail": (
            "Request form deleted successfully"
            if outcome == "deleted"
            else "Request form archived successfully"
        )
    }
...
@configuration_router.post(
    ...
    operation_id="services_api_v1_services_activate_request_form",
)
@require_permission("service_request_forms", "update")
...
@configuration_router.post(
    "/{service_id}/pricing-configs",
    response={201: Dict[str, Any], 400: MessageSchema},
    operation_id="services_api_v1_services_create_pricing_config",
)
...
def create_pricing_config(request, service_id: int, payload: PricingConfigIn):
    try:
        service = get_object_or_404(Service, id=service_id)
        config = domain_services.create_pricing_config(
            service,
            payload,
            created_by_id=_current_user_id(request, payload.created_by_id),
        )
...
@configuration_router.get(
    ...
    response=Dict[str, Any],
    operation_id="services_api_v1_services_get_pricing_config",
)
...
@configuration_router.put(
    "/{service_id}/pricing-configs/{config_id}",
    response={200: Dict[str, Any], 400: MessageSchema, 404: MessageSchema},
    operation_id="services_api_v1_services_update_pricing_config",
)
...
def update_pricing_config(
    ...
    try:
        ...
        return 200, _serialize_pricing_config(
            domain_services.update_pricing_config(config, payload)
        )
    except (ValidationError, IntegrityError) as e:
        return 400, {"detail": _validation_detail(e)}
...
@configuration_router.delete(
    "/{service_id}/pricing-configs/{config_id}",
    response={200: MessageSchema, 404: MessageSchema},
    operation_id="services_api_v1_services_delete_pricing_config",
)
...
def delete_pricing_config(request, service_id: int, config_id: int):
    ...
    return 200, {
        "detail": (
            "Pricing config deleted successfully"
            if outcome == "deleted"
            else "Pricing config archived successfully"
        )
    }
...
@configuration_router.post(
    ...
    response={200: Dict[str, Any], 404: MessageSchema},
    operation_id="services_api_v1_services_activate_pricing_config",
)
@require_permission("service_pricing_configs", "update")
...
@configuration_router.get(
    ...
    response=List[Dict[str, Any]],
    operation_id="services_api_v1_services_list_workflows",
)
...
@configuration_router.get(
    ...
    response=Dict[str, Any],
    operation_id="services_api_v1_services_get_workflow",
)
...
@configuration_router.put(
    "/{service_id}/workflows/{workflow_id}",
    response={200: Dict[str, Any], 400: MessageSchema, 404: MessageSchema},
    operation_id="services_api_v1_services_update_workflow",
)
...
def update_workflow(
    ...
    try:
        ...
        return 200, _serialize_workflow(
            domain_services.update_workflow(workflow, payload)
        )
    except (ValidationError, IntegrityError) as e:
        return 400, {"detail": _validation_detail(e)}
...
@configuration_router.delete(
    "/{service_id}/workflows/{workflow_id}",
    response={200: MessageSchema, 404: MessageSchema},
    operation_id="services_api_v1_services_delete_workflow",
)
...
def delete_workflow(request, service_id: int, workflow_id: int):
    ...
    return 200, {
        "detail": (
            ...
            if outcome == "deleted"
            else "Workflow archived successfully"
        )
    }
...
@configuration_router.get(
    ...
    response=List[Dict[str, Any]],
    operation_id="services_api_v1_services_list_workflow_stages",
)
@require_permission("service_workflows", "view")
...
@configuration_router.put(
    ...
    operation_id="services_api_v1_services_replace_workflow_stages",
)
@require_permission("service_workflows", "update")
def replace_workflow_stages(
    ...
    try:
        ...
        return 200, [
            _serialize_workflow_stage(stage)
            for stage in domain_services.replace_workflow_stages(
                workflow, payload.stages
            )
        ]
    except (ValidationError, IntegrityError) as e:
        return 400, {"detail": _validation_detail(e)}
...
@configuration_router.post(
    ...
    operation_id="services_api_v1_services_create_workflow_stage",
)
@require_permission("service_workflows", "update")
...
@configuration_router.put(
    ...
    response={200: Dict[str, Any], 400: MessageSchema, 404: MessageSchema},
    operation_id="services_api_v1_services_update_workflow_stage",
)
@require_permission("service_workflows", "update")
...
@configuration_router.delete(
    "/{service_id}/workflows/{workflow_id}/stages/{stage_id}",
    response={200: MessageSchema, 404: MessageSchema},
    operation_id="services_api_v1_services_delete_workflow_stage",
)
@require_permission("service_workflows", "update")
...
@configuration_router.post(
    "/{service_id}/workflow-seed",
    response={201: Dict[str, Any], 400: MessageSchema},
    operation_id="services_api_v1_services_seed_workflow",
)
@require_permission("service_workflows", "create")
...
@configuration_router.get(
    "/{service_id}/workflow-summary",
    response=List[Dict[str, Any]],
    operation_id="services_api_v1_services_get_workflow_summary",
)
@require_permission("service_workflows", "list")
...
@configuration_router.post(
    ...
    response={200: Dict[str, Any], 404: MessageSchema},
    operation_id="services_api_v1_services_activate_workflow",
)
@require_permission("service_workflows", "update")
...
branch_activation_router = Router(tags=["Services"])


@branch_activation_router.get(
    "/branch-activation-matrix",
    response=List[Dict[str, Any]],
    operation_id="services_api_v1_services_get_branch_activation_matrix",
)
...
@branch_activation_router.get(
    ...
    response=List[Dict[str, Any]],
    operation_id="services_api_v1_services_list_branch_activations",
)
@require_permission("service_branch_activations", "list")
...
@branch_activation_router.put(
    "/{service_id}/branch-activations",
    response={200: List[Dict[str, Any]], 400: MessageSchema},
    operation_id="services_api_v1_services_upsert_branch_activations",
)
