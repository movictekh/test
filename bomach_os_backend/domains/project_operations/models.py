...
class Project(models.Model):
    ...
    file_url = models.URLField(
        max_length=500, null=True, blank=True, help_text="File URL"
    )
...
class Task(models.Model):
    ...
    milestone = models.ForeignKey(
        Milestone, on_delete=models.CASCADE, related_name="tasks", blank=True, null=True
    )
...
class Worksite(models.Model):
    ...
    project = models.ForeignKey(
        Project, on_delete=models.CASCADE, related_name="worksites"
    )
    name = models.CharField(max_length=255)
...
class SiteEquipment(models.Model):
    worksite = models.ForeignKey(
        Worksite, on_delete=models.CASCADE, related_name="equipment"
    )
    name = models.CharField(max_length=255)
...
class Timeline(models.Model):
    ...
    project = models.ForeignKey(
        Project, on_delete=models.CASCADE, related_name="timelines"
    )
    name = models.CharField(max_length=255)
    description = models.TextField(blank=True, null=True)
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default="pending")
