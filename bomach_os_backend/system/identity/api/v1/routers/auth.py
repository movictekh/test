...
from system.identity.api.v1.schemas.auth import (
    ErrorResponse,
...
from system.identity.authentication import get_token_from_request
...
def forgot_password(request: HttpRequest, data: ForgotPasswordRequest):
    ...
    from system.identity.models.user import User as _User
