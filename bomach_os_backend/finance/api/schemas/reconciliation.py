...
class BankStatementLinesIn(Schema):
    lines: List[BankStatementLineIn]


class BankReconciliationMatchIn(Schema):
...
class BankReconciliationMatchOut(Schema):
    ...
    matched_amount: Decimal
    match_type: str
    matched_by_id: Optional[int] = None
    matched_at: datetime
    notes: str
...
class BankReconciliationSummaryOut(Schema):
    statement_opening_balance: Decimal
    statement_credits: Decimal
    statement_debits: Decimal
    calculated_statement_closing_balance: Decimal
    statement_closing_balance: Decimal
    statement_internal_difference: Decimal
    book_closing_balance: Decimal
    outstanding_gl_net: Decimal
    adjusted_statement_balance: Decimal
    unexplained_difference: Decimal
    unmatched_statement_amount: Decimal
    unmatched_statement_count: int
    unmatched_gl_amount: Decimal
