...
class FixedAssetCategoryIn(Schema):
    ...
    name: str
    description: str = ""
    asset_ledger_account_id: int
    accumulated_depreciation_ledger_account_id: int
    depreciation_expense_ledger_account_id: int
    default_useful_life_months: int
    default_residual_value_percent: Decimal = Decimal("0.00")


class FixedAssetCategoryUpdate(Schema):
    name: Optional[str] = None
    description: Optional[str] = None
    asset_ledger_account_id: Optional[int] = None
    accumulated_depreciation_ledger_account_id: Optional[int] = None
    depreciation_expense_ledger_account_id: Optional[int] = None
    default_useful_life_months: Optional[int] = None
    default_residual_value_percent: Optional[Decimal] = None
...
class FixedAssetCapitalizeIn(Schema):
    capitalization_date: Optional[date] = None


class FixedAssetDepreciateIn(Schema):
    period_end: date
...
class FixedAssetOut(Schema):
    ...
    disposal_finance_account_id: Optional[int] = None
