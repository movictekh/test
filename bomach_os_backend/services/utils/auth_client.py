...
class AuthClient:
    ...
    def get_user_info(self, user_id: int, token: str = None) -> Optional[Dict[str, Any]]:
    ...
    def get_employee_info(self, employee_id: str, token: str = None) -> Optional[Dict[str, Any]]:
    ...
    def get_client_info(self, client_id: str, token: str = None) -> Optional[Dict[str, Any]]:
    ...
    def validate_client_id(self, client_id: str, token: str = None) -> bool:
