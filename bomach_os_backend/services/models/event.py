...
class Event(models.Model):
    ...
    event_type = models.CharField(max_length=50, choices=EVENT_TYPE_CHOICES, verbose_name=_("Event Type"))
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='planning', verbose_name=_("Status"))

    # Location Information
    venue_name = models.CharField(max_length=255, blank=True, verbose_name=_("Venue Name"))
    ...
    online_platform = models.CharField(max_length=100, blank=True, verbose_name=_("Online Platform"))
    ...
    duration_hours = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True, verbose_name=_("Duration (Hours)"))

    # Registration Information
    max_registrations = models.PositiveIntegerField(default=100, verbose_name=_("Maximum Registrations"))
    current_registrations = models.PositiveIntegerField(default=0, verbose_name=_("Current Registrations"))
    ...
    allow_registration = models.BooleanField(default=True, verbose_name=_("Allow Registration"))
    ...
    target_audience = models.CharField(max_length=500, blank=True, verbose_name=_("Target Audience"))
