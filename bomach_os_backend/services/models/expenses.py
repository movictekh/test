...
class Expense(models.Model):
    ...
    expense_number = models.CharField(max_length=50, unique=True, editable=False, null=True, blank=True)
    ...
    cost_type = models.CharField(
        max_length=30,
        choices=COST_TYPE.choices,
        default=COST_TYPE.OPERATING_EXPENSE
    )

    category = models.CharField(
        max_length=50,
        choices=CATEGORY_CHOICES,
        default=CATEGORY_CHOICES.OTHER
    )
