...
class Property(models.Model):
    ...
    price = models.DecimalField(
        max_digits=15, decimal_places=2, verbose_name="Price",
        validators=[MinValueValidator(Decimal('0.00'))]
    )
    size = models.DecimalField(
        max_digits=10, decimal_places=2, verbose_name="Size (sqm)",
        validators=[MinValueValidator(Decimal('0.00'))]
    )
    ...
    images = models.JSONField(default=list, blank=True, verbose_name="Property Images (URLs)")
