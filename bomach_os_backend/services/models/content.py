...
class Content(models.Model):
    ...
    body = models.TextField(
        blank=True, verbose_name=_("Content Body"), help_text=_("Main content/text")
    )
    ...
    published_date = models.DateTimeField(
        blank=True, null=True, verbose_name=_("Published Date")
    )
    ...
    slug = models.SlugField(
        max_length=500, unique=True, blank=True, verbose_name=_("URL Slug")
    )
    external_url = models.URLField(blank=True, verbose_name=_("External URL"))
    meta_description = models.CharField(
        max_length=160, blank=True, verbose_name=_("Meta Description")
    )
...
class ContentCalendarItem(models.Model):
    ...
    platform = models.CharField(
        max_length=40, choices=PLATFORM_CHOICES, default="multiple"
    )
    ...
    funnel_stage = models.CharField(
        max_length=30, choices=FUNNEL_STAGE_CHOICES, blank=True
    )
...
class MediaLibraryAsset(models.Model):
    ...
    asset_type = models.CharField(
        max_length=30, choices=ASSET_TYPE_CHOICES, default="other"
    )
