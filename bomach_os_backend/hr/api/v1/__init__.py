...
# from .monthly_scorecards import router as monthly_scorecards_router
# from .employee_evaluations import router as employee_evaluations_router
...
# v1_router.add_router('/monthly-scorecards', monthly_scorecards_router)
# v1_router.add_router('/employee-evaluations', employee_evaluations_router)
# v1_router.add_router('/kpis', kpis_router)
# v1_router.add_router('/applicants', interviews_router)
# v1_router.add_router('/applicants', offer_letters_router)
