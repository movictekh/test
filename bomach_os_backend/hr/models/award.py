...
class Award(BaseModel):
    ...
    title = models.CharField(
        max_length=255, help_text="Title of the award (e.g., Employee of the Month)"
    )
    ...
    date_awarded = models.DateField(help_text="Date the award was given")
    ...
    description = models.TextField(
        blank=True, null=True, help_text="Optional description or reason for the award"
    )
