...
describe('real estate mappers', () => {
  it('maps paginated estate responses', () => {
    const result = mapEstateList({
      count: 1,
      items: [
        {
          id: 7,
          is_our_estate: true,
          estate_name: 'Riverside Estate',
          estate_code: 'EST-007',
          estate_type: 'residential',
          estate_type_display: 'Residential',
          developer_company_name: 'Bomach',
          estate_description: 'Residential estate',
          country: 'Nigeria',
          state: 'Enugu',
          city_town: 'Enugu',
          precise_address: 'Independence Layout',
          price_per_sqm: '50000.00',
          estate_status: 'available',
          estate_status_display: 'Available',
          area_unit: 'sqm',
          amenities: ['Roads'],
          title_documents: ['Survey Plan'],
