...
export const realEstateKeys = {
  ...
  propertyList:(estateId:number,f:PropertyFilters)=>[...realEstateKeys.properties(estateId),'list',f] as const,
  propertyDetail:(estateId:number,id:number)=>[...realEstateKeys.properties(estateId),'detail',id] as const,
